...
import com.leetcode.andrucuna.algorithms.PalindromeNumber;


/**
 * Test algorithm "PalindromeNumber.java"
 * 
...
public class PalindromeNumberTest {
	 ...
	 */
	private static final String TEST_CASES_FILE_PATH = "./test/test-cases/PalindromeNumberTC";
		...
		try {
		    ...
		    for ( int i = 0; i<testCases; i++ ) {
		        ...
		        if( line != null ) {
		        	...
		        	outputs[i] = Boolean.parseBoolean( (line.split(" ")[1]).trim() );
		        }
		    }
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void testIsPalindromeAlgorithm() {
		...
		try {
			for (int i = 0; i < inputs.length; i++) {
				...
				boolean result = p.isPalindrome( inputs[i] );
